...
<body class="off">
	...
	<audio src="/assets/sounds/1.mp3"></audio>
	<audio src="/assets/sounds/2.mp3"></audio>
	<audio src="/assets/sounds/3.mp3"></audio>
	<audio src="/assets/sounds/4.mp3"></audio>
	<audio src="/assets/sounds/5.mp3"></audio>
	<audio src="/assets/sounds/6.mp3"></audio>
